...
from gestorObjetos.models import Objeto,Autor,PalabraClave
...
def Proyecto(request):
	...
	'''
		...
		return render_to_response('proyecto.html', {'usuario':request.user, 'proyecto':proyectoPro1}, context_instance=RequestContext(request))
